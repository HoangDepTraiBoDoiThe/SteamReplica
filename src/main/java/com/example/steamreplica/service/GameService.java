...
public class GameService {
    ...
    public CollectionModel<EntityModel<GameResponse_Basic>> getGamesOfCategory(int page, long categoryId, Authentication authentication) {
        return cacheHelper.getPaginationCache(GAME_OF_CATEGORY_PAGINATION_CACHE_PREFIX, GameResponse_Basic.class, page, gameRepository, repo -> {
            List<Game> games = repo.findAllByCategoryId(categoryId, PageRequest.of(page, PAGE_SIZE)).getContent();
    ...
    public CollectionModel<EntityModel<GameResponse_Basic>> getNewAndTrendingGames(int page, Authentication authentication) {
        return cacheHelper.getPaginationCache(NEW_AND_TRENDING_GAME_PAGINATION_CACHE_PREFIX, GameResponse_Basic.class, page, gameRepository, repo -> {
    ...
    public CollectionModel<EntityModel<GameResponse_Basic>> getTopSellerGames(int page, Authentication authentication) {
        return cacheHelper.getPaginationCache(TOP_SELLER_GAME_PAGINATION_CACHE_PREFIX, GameResponse_Basic.class, page, gameRepository, repo -> {
    ...
    public CollectionModel<EntityModel<GameResponse_Basic>> getSpecialGames(int page, Authentication authentication) {
        return cacheHelper.getPaginationCache(SPECIAL_GAME_PAGINATION_CACHE_PREFIX, GameResponse_Basic.class, page, gameRepository, repo -> {
            List<Game> mostDownloadedGames = repo.findAllByOrderByDownloadedCountDescWithAvailableDiscounts(PageRequest.of(page, PAGE_SIZE)).toList();
    ...
    public CollectionModel<EntityModel<GameResponse_Basic>> getDevOwningGames(int page, long user_id, Authentication authentication) {
        return cacheHelper.getPaginationCache(DEV_OWNING_GAME_PAGINATION_CACHE_PREFIX, GameResponse_Basic.class, page, gameRepository, repo -> {
            List<Game> mostDownloadedGames = repo.findAllByDevOwner(user_id, PageRequest.of(page, PAGE_SIZE)).toList();
            CollectionModel<EntityModel<GameResponse_Basic>> entityModels = serviceHelper.makeGameResponse_CollectionModel(GameResponse_Basic.class, mostDownloadedGames, authentication);
    ...
    public CollectionModel<EntityModel<GameResponse_Basic>> getPublisherOwningGames(int page, long user_id, Authentication authentication) {
        return cacheHelper.getPaginationCache(PUBLISHER_OWNING_GAME_PAGINATION_CACHE_PREFIX, GameResponse_Basic.class, page, gameRepository, repo -> {
            List<Game> mostDownloadedGames = repo.findAllByPublisherOwner(user_id, PageRequest.of(page, PAGE_SIZE)).toList();
            CollectionModel<EntityModel<GameResponse_Basic>> entityModels = serviceHelper.makeGameResponse_CollectionModel(GameResponse_Basic.class, mostDownloadedGames, authentication);
    ...
    public EntityModel<GameResponse_Full> getGameById(long id, Authentication authentication) {
        return cacheHelper.getCache(GAME_CACHE, GameResponse_Full.class, id, gameRepository, repo -> {
    ...
    public EntityModel<GameResponse_Full> updateGame(long id, GameRequest gameRequest, Authentication authentication) {
        ...
        EntityModel<GameResponse_Full> entityModel = serviceHelper.makeGameResponse(GameResponse_Full.class, updatedGame, authentication);
        cacheHelper.updateCache(entityModel, GAME_CACHE);
        cacheHelper.deleteListCaches(GAME_LIST_CACHE);
        cacheHelper.updatePaginationCache(entityModel, PAGE_RANGE,
    ...
    public void deleteGame(long id) {
        ...
        cacheHelper.deletePaginationCache(PAGE_RANGE,
                NEW_AND_TRENDING_GAME_PAGINATION_CACHE_PREFIX,
                TOP_SELLER_GAME_PAGINATION_CACHE_PREFIX,
                DEV_OWNING_GAME_PAGINATION_CACHE_PREFIX,
                PUBLISHER_OWNING_GAME_PAGINATION_CACHE_PREFIX,
